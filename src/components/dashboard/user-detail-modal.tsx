        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
          ...
          {isCustomer && (
            <div>
              ...
              <InfoRow icon={<Calendar size={13} />} label="Start Date" value={formatDate(customer.createdAt)} />
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
            ...
            <div>
              ...
              <InfoRow icon={<Globe size={13} />} label="City / Country" value={`${user.pobCity}, ${user.pobCountry}`} />
            </div>
          </div>
        </div>
