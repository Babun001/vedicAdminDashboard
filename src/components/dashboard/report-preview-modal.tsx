      ...
      >
        ...
        {customer && (
          <div className="flex items-center gap-3 bg-cosmos-500/10 border border-cosmos-500/20 rounded-xl px-4 py-3 mb-5">
            ...
            <div>
              <p className="text-sm font-medium text-white leading-tight">{customer.name}</p>
              <p className="text-xs text-white/50 leading-tight mt-0.5">{customer.email}</p>
            </div>
            <div className="ml-auto text-right hidden sm:block">
              <p className="text-xs text-white/40">DOB: {customer.dob}</p>
              <p className="text-xs text-white/40 mt-0.5">{customer.pobCity}, {customer.pobCountry}</p>
            </div>
          </div>
        )}
        ...
        */}
        ...
        {report.adminNotes && (
          <div className="flex gap-3 bg-gold-500/8 border border-gold-500/20 rounded-xl px-4 py-3">
            <FileText size={14} className="text-gold-400 shrink-0 mt-0.5" />
            <div>
              <p className="text-xs text-gold-400 font-medium mb-1">Admin Notes</p>
              <p className="text-xs text-white/60 leading-relaxed">{report.adminNotes}</p>
            </div>
          </div>
        )}
      </div>
