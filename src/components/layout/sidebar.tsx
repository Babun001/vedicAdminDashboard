...
export function Sidebar() {
  ...
  const superAdminNavItems = [
    ...
    {
      href: "/dashboard/superadmin/create",
      label: "Create Admin",
      icon: PlusSquare,
    },
  ];
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-[#FFF8F1] border-r border-[#EAD9C8] flex flex-col z-40">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        <p className="text-[10px] text-[#A08F7D] font-body tracking-widest uppercase px-3 mb-3">
          Navigation
        </p>
        ...
        {user && (
          <div className="flex items-center gap-3 px-3 py-2.5 mb-2">
            ...
            <div className="min-w-0">
              <p className="text-xs font-medium text-[#3B2F2F] truncate">
                {user.name}
              </p>
