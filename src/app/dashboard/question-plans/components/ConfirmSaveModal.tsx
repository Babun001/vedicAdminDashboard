...
import { CheckCircle2, IndianRupee, DollarSign, HelpCircle } from "lucide-react";
            ...
            <div className="bg-white rounded-3xl w-full max-w-md shadow-xl overflow-hidden">
                <div className="p-6 text-center border-b border-gray-100">
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                        Please confirm the question plan details.
                    </p>
                </div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="flex items-center gap-1 font-semibold text-gray-900">
                                {priceINR !== undefined && priceUSD !== undefined ? (
                                    <>
                                        {priceINR !== 0 ? <IndianRupee size={15} /> : <DollarSign size={15} />}
                ...
                <div className="border-t border-gray-100 p-5 flex justify-end gap-3">
                    ...
                    <Button variant="gold" onClick={onConfirm}>Confirm</Button>
                </div>
            </div>
        </div>
    );
