        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-5" style={{ marginTop: 0 }}>
            <div className="bg-white rounded-3xl w-full max-w-md shadow-xl overflow-hidden">
                <div className="p-6 text-center border-b border-gray-100 relative">
                    ...
                    <div className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center ${isActive ? "bg-yellow-100" : "bg-green-100"}`}>
                        <Power size={30} className={isActive ? "text-yellow-600" : "text-green-600"} />
                    </div>
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        {isActive
                            ? "Customers won't be able to buy this question pack."
                            : "Customers will be able to buy this question pack."}
                    </p>
                </div>
                            ...
                            <div className="flex gap-6">
                                <div className="flex items-center gap-2 rounded-lg bg-orange-50 px-3 py-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold">₹{plan.priceINR.toLocaleString("en-IN")}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 rounded-lg bg-green-50 px-3 py-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold">${plan.priceUSD.toLocaleString("en-US")}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="border-t border-gray-100 p-5 flex justify-end gap-3">
                    ...
                    <Button variant={isActive ? "danger" : "gold"} onClick={() => onConfirm(plan._id)}>
