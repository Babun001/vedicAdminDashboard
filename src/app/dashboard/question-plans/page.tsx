...
import { useQuestionPlans } from "./hooks/usePlans";
...
export default function QuestionPlanPage() {
    const {
        filteredPlans,
    ...
    const [selectedPlan, setSelectedPlan] =
        useState<QuestionPlan | null>(null);
                ...
                {filteredPlans.length === 0 ? (
                    <div className="col-span-2 bg-white rounded-2xl border border-gray-200 py-20 text-center">
                        <h3 className="text-lg font-semibold text-gray-700">
                            No Question Plans Found
                        </h3>
                        <p className="text-gray-500 mt-2">
                            Create your first question plan
                            to get started.
                        </p>
                    </div>
